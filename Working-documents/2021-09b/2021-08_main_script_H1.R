...
save.image("~/Code_PAPER_biost/results/results_H0False_withss.RData") 
...
t1=Sys.time()-t0  
# save.image("~/Code_PAPER_biost/results/results_H0False_withoutss.RData") 
save.image("~/Code_PAPER_biost/results/results_H0False_withoutss2.RData") 
