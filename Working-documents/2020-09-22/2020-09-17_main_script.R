...
# load("C:/Users/Marta/Dropbox/C5/Scripts/GitKraken/CBE_selection/results/results_H0_False.RData")
#########################################
...
for(i in 1:dim(dataset)[1]){
  dataset$Test_Reject_ES_ub[i] <- tryCatch(sum(replicate(nsim,
                                                      f_ES2_ub(samplesize=dataset$samplesize_e1[i]/2,
                                                            p0_e1=dataset$p0_e1[i],p1_e1=dataset$p0_e1[i],
                                                            OR1=dataset$OR1[i],
                                                            p0_e2=dataset$p0_e2[i],p1_e2=dataset$p0_e2[i],
                                                            OR2=dataset$OR2[i],
