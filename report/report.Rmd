...
for(i in 1:max(dataset_SSadd$scenario)){
  sub=subset(dataset_SSadd,dataset_SSadd$scenario==i)
  # sub=subset(dataset,dataset$scenario==i)
  # 
  
  p[[enum]] <-ggplot(sub, aes(x=corr, y=Test_Power_ES_bSS, color=as.factor(ss_decision)))  +
...
signlevel_data <- data.frame(signlevel=c(dataset$Test_Reject_ES,
                                         ...
                                         dataset$Test_Reject_ES_bSS,
                                         dataset$Test_Reject_ES_ubSS,
                                         dataset$Test_Reject_CE,dataset$Test_Reject_RE),
                             Endpoint=c(rep("SE",length(dataset$Test_Power_ES)),
                                        rep("SE(ub)",length(dataset$Test_Reject_ES_ub)),
                                        rep("SE (ss/b)",length(dataset$Test_Reject_ES_bSS)),
                                        rep("SE (ss/ub)",length(dataset$Test_Reject_ES_ubSS)),
                                        rep("CE",length(dataset$Test_Power_CE)),
                                        rep("RE",length(dataset$Test_Power_RE)))
                             )
...
summary(data.frame(Test_Reject_ES_bSS=dataset$Test_Reject_ES_bSS,Test_Reject_ES_ubSS=dataset$Test_Reject_ES_ubSS))
```
